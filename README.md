...
This mod acts as a balance compatability patch between Combat Equipment Evolved and The Cole Protocol.
...
This template is licensed under [APL-SA](LICENSE.md).
